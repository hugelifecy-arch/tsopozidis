      ...
      <div className="max-w-container mx-auto px-4 md:px-8 pb-8">
        <div className="text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-gold/30 text-gold px-6 py-2 text-xs font-display uppercase tracking-wider hover:bg-gold/10 transition-all duration-300"
          >
