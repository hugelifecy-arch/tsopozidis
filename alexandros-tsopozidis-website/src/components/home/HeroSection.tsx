      ...
      <div className="relative z-10 text-center px-4">
        {mounted ? (
          ...
          <>
            ...
            <div className="h-[1px] gold-line mx-auto mb-8" style={{ width: 120 }} />
            <p className="font-serif font-light text-lg sm:text-xl md:text-2xl tracking-[0.5em] text-gold/70">
              ALEXANDROS
            </p>
            <h1 className="font-display font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-[0.1em] text-gold-gradient mt-2">
              TSOPOZIDIS
            </h1>
            <p className="font-serif italic text-base text-text-secondary tracking-[0.3em] lowercase mt-4">
              {t('tagline')}
            </p>
            <div className="h-[1px] gold-line mx-auto mt-8" style={{ width: 120 }} />
